...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <p>
            <a href="#facebookTools" class="btn btn-primary my-2">Facebook Tools</a>
            <a href="#youtubeTools" class="btn btn-danger my-2">Youtube Tools</a>
        </p>
    </div>
</section>
<?php if (!empty($data['facebook'])): ?>
    <div class="py-5 bg-light" id="facebookTools">
        <div class="container">
            <div class="row">
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="<?php echo $v['url']; ?>" class="btn btn-sm btn-outline-secondary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php if (!empty($data['youtube'])): ?>
    <div class="py-5 bg-danger" id="youtubeTools">
        <div class="container">
            <div class="row">
