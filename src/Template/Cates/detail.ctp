...
<div class="breadcrumbs">
    <div class="container">
        <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
            ...
            <li class="active"><?php echo !empty($cate['name']) ? $cate['name'] : ''; ?></li>
        </ol>
    </div>
</div>
<!-- //breadcrumbs -->
            ...
            <div class="products-right-grid">
                <div class="products-right-grids">
                    <div class="sorting">
                        ...
                        <input type="hidden" value="<?php echo $BASE_URL.'/danh-muc/'.$cate['url'].'?'.http_build_query($sortByParam);?>" id="sortByParam"/>
                    </div>
                    <div class="sorting-left">
                        ...
                        <input type="hidden" value="<?php echo $BASE_URL.'/danh-muc/'.$cate['url'].'?'.http_build_query($param);?>" id="limiDataParam"/>
                    </div>
